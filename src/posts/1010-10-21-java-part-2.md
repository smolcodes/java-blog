...
In [Part 1](https://smolnotes.netlify.app/posts/installingjavaasablindperson/) of this series, we modified our coding enviroment so we can start programming without straining our eyes; in this post we will install Java and write our first program!
...
In the command prompt type <code>javac -version. After, enter in <code>java -version</code>. If both return errors that's ok!
...
Congradulations!! A lot was covered in this post and you just wrote your first program! It's okay if you don't know what it is you just did or what any of it means. You'll get there.
_____
